    ...
    <div className="flex flex-col min-h-screen">
            ...
            <div className="card p-6">
              <div className="flex items-center mb-4">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-gray-600">Tomato Grower, Maharashtra</p>
                </div>
              </div>
              <p className="text-gray-600">
                "I used KrishiMitra AI to check market prices before selling. It helped me get a better price than usual."
              </p>
              <div className="flex mt-4">
                {[...Array(4)].map((_, i) => (
                  <svg key={i} className="w-5 h-5 text-accent-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="card p-6">
              <div className="flex items-center mb-4">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-gray-600">Rice Farmer, West Bengal</p>
                </div>
              </div>
              <p className="text-gray-600">
                "Weather forecasts helped me schedule irrigation perfectly. This app is a real game-changer!"
              </p>
              <div className="flex mt-4">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} className="w-5 h-5 text-accent-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
      ...
      <footer className="bg-primary-900 text-primary-200 py-8">
        <div className="container-custom flex flex-col md:flex-row justify-between items-center gap-4">
          <p>&copy; 2024 KrishiMitra AI. All rights reserved.</p>
