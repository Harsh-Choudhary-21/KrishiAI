    ...
    <div className="container-custom py-8">
      <div className="max-w-4xl mx-auto">
        <div className="card overflow-hidden">
          ...
          <div className="p-6">
            {!preview ? (
              <div {...getRootProps()} className={`upload-area ${isDragActive ? 'upload-area-active' : ''} cursor-pointer`}>
                <input {...getInputProps()} />
                <FiUpload className="w-12 h-12 text-gray-400 mx-auto mb-4" />
                <p className="text-gray-600 font-medium">
                  {isDragActive ? "Drop the image here..." : "Drag and drop an image here, or click to select"}
                </p>
                <p className="text-gray-500 text-sm mt-2">Supported formats: JPG, PNG (Max: 5MB)</p>
                <button
                  type="button"
              ...
              <div className="space-y-6">
                <div className="relative h-64 md:h-80 rounded-lg overflow-hidden border border-gray-200">
                  <Image src={preview} alt="Plant image" fill style={{ objectFit: 'contain' }} />
                </div>
                  ...
                  >
                    ...
                    <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
                      <button
                        ...
                        onClick={() => toast.success('Treatment recommendations saved!')}
                      >
                        Save Results
                      </button>
                      <button
          ...
          <div className="bg-gray-50 p-6 border-t border-gray-200">
            ...
            <ul className="text-gray-600 text-sm space-y-2">
              <li><span className="text-primary-600 mr-2">•</span>Take clear, well-lit photos of the affected plant parts</li>
              <li><span className="text-primary-600 mr-2">•</span>Include both healthy and diseased areas for comparison</li>
              <li><span className="text-primary-600 mr-2">•</span>Get close-up shots of any visible symptoms (spots, lesions, etc.)</li>
              <li><span className="text-primary-600 mr-2">•</span>For best results, avoid shadows and use natural daylight</li>
            </ul>
          </div>
        </div>
